...
class Setting{
    ...
    public function login_prime_save_settings(){
        ...
        $data = [
            ...
            'login_form_header_text' => isset($_POST['login_form_header_text']) ? stripslashes(sanitize_text_field($_POST['login_form_header_text'])) : "",
            'login_form_subheader_text' => isset($_POST['login_form_subheader_text']) ? stripslashes(sanitize_text_field($_POST['login_form_subheader_text'])) : "",
            'registration_form_header_text' => isset($_POST['registration_form_header_text']) ? stripslashes(sanitize_text_field($_POST['registration_form_header_text'])) : "",
            'login_tab_text' => isset($_POST['login_tab_text']) ? stripslashes(sanitize_text_field($_POST['login_tab_text'])) : "",
            'register_tab_text' => isset($_POST['register_tab_text']) ? stripslashes(sanitize_text_field($_POST['register_tab_text'])) : "",
            'login_button_text' => isset($_POST['login_button_text']) ? stripslashes(sanitize_text_field($_POST['login_button_text'])) : "",
            'register_button_text' => isset($_POST['register_button_text']) ? stripslashes(sanitize_text_field($_POST['register_button_text'])) : "",
            'reset_password_button_text' => isset($_POST['reset_password_button_text']) ? stripslashes(sanitize_text_field($_POST['reset_password_button_text'])) : "",
            'username_label_text' => isset($_POST['username_label_text']) ? stripslashes(sanitize_text_field($_POST['username_label_text'])) : "",
            'username_placeholder_text' => isset($_POST['username_placeholder_text']) ? stripslashes(sanitize_text_field($_POST['username_placeholder_text'])) : "",
            'password_label_text' => isset($_POST['password_label_text']) ? stripslashes(sanitize_text_field($_POST['password_label_text'])) : "",
            'password_placeholder_text' => isset($_POST['password_placeholder_text']) ? stripslashes(sanitize_text_field($_POST['password_placeholder_text'])) : "",
